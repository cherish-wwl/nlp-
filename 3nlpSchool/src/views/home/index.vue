<template>
  <div class="nlpschool"> 
    <el-row>
      <img src="../../assets/home/u4199.jpg"/>
    </el-row>
    <el-row class="classroomContent" :gutter="20">
      <el-col :span="18" >
        <div class="classroomDiv">
          <div class="title_line">
            <img class="icon" src="../../assets/home/u4538.png">
          ...
          <el-row class="lesson_content" :gutter="30">
            <el-col  :span="8" v-for=" item in lessonData" :key="item.id">
              <div  class="lesson-item" @click="jumpDetails(item)">
                ...
                <p class="c333 font16">
                  <img class="icon2" src="../../assets/home/u4327.png">
                  &nbsp;{{ item.title }}
                </p>
                <p class="c999 font14">
                  <img class="icon2" src="../../assets/home/u4329.png">
                  &nbsp;{{ item.type }}
                </p>
                <p class="c999 font14">
                  <img class="icon2" src="../../assets/home/u4331.png">
                  &nbsp;{{ item.auther }}
                </p> 
              </div>
            </el-col>
      ...
      <el-col :span="6" class="lecturer">
        <div class="title_line">
            <img class="icon" src="../../assets/home/u4542.png">
