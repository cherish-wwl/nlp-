<template>
  <el-container class='pc_service_class'>
             ...
             if(this.currentServiceId == Third[j].id){
               console.log(Third[j].name)
                ...
                var currentServiceInfo = { 
                  service_bg_img:this.service_bg_img,
                  service_title:this.serviceInfo.service_title,
                  service_desc:this.serviceInfo.service_desc
                }
                this.$emit("initServiceInfo",currentServiceInfo)
                break 
             }
          }
        }
